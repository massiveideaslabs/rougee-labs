      ...
      <div className="container mx-auto px-6 flex justify-between items-center">
        <a href="#" className="flex items-center gap-2 group cursor-none pointer-events-auto" data-interactive="true">
          ...
          <div className="flex flex-col">
            <span className="font-bold text-xl tracking-tighter text-white group-hover:text-neon-cyan transition-colors">
              ROUGEE
            </span>
            <span className="text-[10px] tracking-[0.3em] text-gray-400 font-mono uppercase">Labs</span>
          </div>
        </a>
        ...
        <div className="flex items-center gap-4 pointer-events-auto">
          ...
          <div className="hidden md:flex items-center gap-2 px-4 py-2 border border-neon-cyan/20 bg-neon-cyan/5 text-neon-cyan font-mono text-xs uppercase tracking-widest rounded-sm h-[34px] shadow-[0_0_10px_-5px_rgba(0,243,255,0.2)] select-none">
